...
export default function OwnerOnboarding() {
  ...
  const greeting = `Hi ${firstName}! I'll help you set up your business and create a loyalty program in just a few steps.\n\nWhat's the name of your business?`
        ...
        return (
          <Button
            ...
            onClick={() => {
              ...
              push('user', `${goalLabel} · ${visitFreq === 'weekly' ? 'Weekly' : visitFreq === 'monthly_2_3' ? '2–3×/month' : 'Monthly'} · ${rewardType === 'discounts' ? 'Discounts' : rewardType === 'perks' ? 'Perks' : rewardType === 'points' ? 'Points' : 'Not sure'}`)
  ...
  return (
    <div className="flex flex-col h-full bg-background">
      ...
      <div className="flex-1 overflow-y-auto px-4 py-6 flex flex-col gap-4 min-h-0">
        {/* Opening greeting is always the first message */}
        <AiMessage text={greeting} />
        ...
        {/* Rich content for the current step */}
        {renderThreadContent()}
